...
with_mock_api({
  test_that("We can create a COP22 datapack schema", {
    ...
    test_dataset <- unPackSchema_datapack(test_sheet("COP22_Data_Pack_Template.xlsx"),
                                          cop_year = 2022)
    ...
    expect_type(test_dataset$col_name, "character")
  ...
  test_that("We can create a COP21 datapack schema", {
