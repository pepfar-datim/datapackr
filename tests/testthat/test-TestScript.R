...
test_that("All", {
  ...
  output_folder <- "~/datapackr_test_files/Data Packs"
...
#                      model_data_path)
  ...
  # d <- unPackTool("/Users/sam/datapackr_test_files/for_PSNUxIM copy/Data Pack_Mozambique_20200120225201_2.17 HTS Rounding fixed PrEP PP OVC updated 237pm.xlsx")
  # d <- writePSNUxIM(d,
  #                   snuxim_model_data_path,
  #                   output_folder)
  # 
  # 
  # 
  # output_folder <- "~/datapackr_test_files/Data Packs SNUxIM update"
  ...
  # 
  # 
  # d <- unPackTool("~/datapackr_test_files/for_repack_PSNUxIM copy/Data Pack_Mozambique_20200226231716 2.27.20 115pm.xlsx")
  # d <- writePSNUxIM(d,
  #                   snuxim_model_data_path,
  #                   output_folder)
  # d <- datapackr::checkAnalytics(d, model_data_path = model_data_path)
