context("Create a DATIM/PAW export object")

test_that("Can export COP24 DATIM or PAW data", {

  # create mock cop24 pack datim object
  d <- list()
  ...
  paw_export <- createDATAExport(d, export_type = "paw")
  ...
  # TEST PAW EXPORT ----
  datim_export <- createDATAExport(d, export_type = "datim")
  pop_data <- c("KssDaTsGWnS", "lJtpR5byqps", "nF19GOjcnoD", "P2XNbiNnIqV")
  testthat::expect_equal(
    0,
    datim_export %>%
