  ...
  if (NROW(missing_metadata) > 0) {
    ...
    warning_msg <-
      paste0(
        "ERROR! In tab ",
        sheet,
        ", MISSING PSNU, INDICATOR_CODE, OR ID: Review any tabs flagged by this test to investigate whether PSNU, Age, Sex, or
          Key Population identifier information data have been deleted.",
